...
\vspace{-0.4mm}
  ...
  \resumeSubheading
      ...
      \resumeItemListStart
\item Developed enterprise-grade full-stack features in Spring Boot, React/Angular.
...
\vspace{-0.4mm}
 \resumeHeadingSkillStart
  \resumeSubItem{Programming Languages:}
    {Java, Python, TypeScript, JavaScript, SQL, C++, Golang, Dart, C++}
  \resumeSubItem{Backend:}
  {Spring Boot, REST APIs, Microservices, Kafka, Django,Flask}
  \resumeSubItem{Frontend:}
  {React, Angular, HTML, CSS, Flutter, nextjs}
  \resumeSubItem{Infra:}
    {Docker, Kubernetes, Jenkins, Linux/Unix}
   \resumeSubItem{Core Strengths: }
    {Distributed Systems, System Design, Accessibility (WCAG), Debugging, Algorithms}
  \resumeSubItem{Other Skills:}
    { Git, Pytorch, Hugging Face, Tensorflow }
